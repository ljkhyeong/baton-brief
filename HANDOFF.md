...
대조했다. 신호 종류·심각도·영속 생명주기·외부 집계 리비전·전용 outbox가 일치하지 않아
직접 연동하지 않고, BATON이 소유해야 할 의미·정체성·재조정·전송 선행조건을 채택했다.
...
- PRD-0018에서 BATON 생산자 연동 전에 권위 있는 신호 의미, 안정적 정체성·상태 생명주기,
  ...
  직렬화·종단 간 검증을 모두 갖추도록 선행 게이트를 채택했다.
...
- BATON, WATCH, RELAY, GO 생산자와의 종단 간 연동은 없다. 현재 BATON 연속성 신호는
  BRIEF 이벤트 v1과 종류·생명주기·리비전 의미가 달라 PRD-0018의 선행 결정이 필요하다.
