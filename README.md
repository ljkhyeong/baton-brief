...
- [주간 해소 요약](docs/PRD/0030_weekly-resolution-summary/spec.md)은 연속된 활성·해소 전환과
  현재 해소 상태를 함께 확인한 전체 건수와 상세 목록을 반환한다. 해소 시점·리비전을 보존하며
  재활성화·해소 시점의 기록 공백은 제외한다. 목록은 배타 커서로 넘겨 본다.
