...
| 문서 | 소유 내용 |
| --- | --- |
| `README.md` | 제품 소개, 주요 기능, 첫 실행 방법과 주요 문서 진입점 |
...
| 문서 | 상태 | 내용 |
| --- | --- | --- |
| [PRD-0013 현재 단건 조회](PRD/0013_current-attention-item/spec.md) | 채택됨 | 복합 식별자로 현재 투영 단건 조회 |
...
| [PRD-0016 상태 변경 이력](PRD/0016_attention-item-transitions/spec.md) | 채택됨 | 실제 적용 전이의 집계 리비전 키셋 조회 |
...
| 문서 | 상태 | 내용 |
| --- | --- | --- |
| [PRD-0003 브리프 이력](PRD/0003_edition-history/spec.md) | 채택됨 | `generation` 배타 키셋 이력 조회 |
