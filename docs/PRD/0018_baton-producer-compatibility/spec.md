...
- 상태: 채택됨
- 결정일: 2026-08-22
- 구현 상태: BATON 생산 의미·BRIEF 소비자 v2 구현, BATON 생산자 미구현
...
다음 구현 진입점은 BATON 실제 직렬화 계약 아티팩트와 생산자 신호 스트림·전용 outbox다.
BRIEF v2 소비자 고정값만으로 생산자 호환이나 종단 간 전달 성공을 주장하지 않는다.
