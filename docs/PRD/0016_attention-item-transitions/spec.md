...
- 상태: 채택됨
- 결정일: 2026-08-22
- 범위: 복합 식별자별 실제 적용 상태 전이의 집계 리비전 키셋 조회

## 목적

PRD-0013~0015는 점검 항목의 마지막 현재 상태를 단건 또는 상태별 목록으로 제공한다. 현재
...
| 메서드 | 경로 | 의미 |
|---|---|---|
| `GET` | `/api/v1/workspaces/{workspaceId}/seasons/{seasonId}/attention-items/transitions` | 점검 항목의 적용 상태 전이 이력 |
...
잘못된 UUID·열거형, PRD-0002의 문자·공백 규칙을 어기거나 Unicode code point 기준
